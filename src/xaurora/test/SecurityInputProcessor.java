...
/**
 * 
 * Description: This class is mainly for generation of Expected output in
...
public final class SecurityInputProcessor {
    ...
    /**
     * Description: Product Expected output for Security Test 1. Reads all text
     * file under the Input folder 2. Encrypt the text data of each text file in
     * the input folder 3. Output the encrypted Text to the Expected Output
     * folder
     * 
     * @author GAO RISHENG A0101891L
     */
    private static void produceExpectedOutput(SystemManager testInstance) {
        ...
        // It repeats with codes in other places of this project like DataFileIO
        // since there is no function pointer in Java
        // to make it more reusable. Also since the information retrieve is
