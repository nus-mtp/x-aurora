...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        wordSvrThread.start();
        /*
         * ArrayList<String> actualResult = new ArrayList<String>(); Scanner sc
         * = new Scanner(System.in); String userInput = sc.nextLine();
         * actualResult = PrefixMatcher.getResult(userInput+"*");
         * System.out.println(actualResult.isEmpty()); for(int i =
         * 0;i<actualResult.size();i++){
